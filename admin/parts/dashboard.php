                    ...
                    <div class="well white">
                        ...
                        <ul>
                           ...
                           while ($query_row_recent_registration = mysqli_fetch_assoc($query_run_recent_registration)) {
                               ?>
                               <li><h5><?php echo $query_row_recent_registration['fullname']; ?></h5> Has Joined Portal as <span class="role"><?php echo $query_row_recent_registration['user_role']; ?></span></li>
                           <?php } ?>
                        </ul>
                        <div class="readmore text-right">
