        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="sp-userimg">
                    <img src="<?php echo "uploads/profile/" . $query_row['images']; ?>"
                         alt="<?php echo $query_row['username']; ?>"/>
                </div>
            </div>
            <div class="col-sm-9">
                <div class="userinfo">
                    <h2><?php echo $query_row['fullname']; ?> &#9670; <span
                            class="user-age"><?php echo $query_row['age']; ?></span>
                    ...
                    <div class="user-bio"><span
                            class="teamname glyphicon glyphicon-globe"><?php echo $query_row['dept_id']; ?> </span>
                                <span
                                    class="languages glyphicon glyphicon-comment"><?php echo $query_row['languages']; ?></span>
                    </div>
                </div>
            </div>
        </div>
